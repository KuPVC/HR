<template>
	...
	>
		...
		<!-- File Preview Modal -->
		<Dialog v-model="showPreviewModal" :options="{ size: '3xl' }">
			<template #body>
				<FilePreviewModal :file="selectedFile" @close="showPreviewModal = false" />
			</template>
		</Dialog>
	</div>
</template>
