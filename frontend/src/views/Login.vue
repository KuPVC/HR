<template>
	<div
		...
		class="flex min-h-screen w-full flex-col bg-white"
	>
	...
	<div v-else class="flex min-h-screen w-full flex-col justify-center bg-white">
		<div class="flex flex-col mx-auto gap-3 items-center">
			<FrappeHRLogo class="h-8 w-8" />
			<div class="text-3xl font-semibold text-gray-900 text-center">
				{{ __("Login to Craft HR") }}
			</div>
		</div>

		<div class="mx-auto mt-10 w-full max-w-sm px-8">
