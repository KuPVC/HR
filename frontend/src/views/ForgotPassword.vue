<template>
	<div class="flex flex-col h-full w-full">
				<div class="w-full h-full bg-white w-full max-w-2xl mx-auto flex flex-col">
					<header
					...
					<div
						class="px-4 pt-4 pb-4 w-full max-w-2xl mx-auto bg-white sticky bottom-0 w-full drop-shadow-xl z-40 border-t rounded-t-lg"
					>
